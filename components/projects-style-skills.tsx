...
const skillsData: SidebarItem[] = [
  {
    ...
    tagline: "Enterprise cloud platforms and services",
    description:
      "Cloud platforms and services I use for building scalable infrastructure",
    longDescription:
      "Comprehensive cloud platforms that provide the foundation for modern, scalable, and resilient infrastructure solutions across various industries and use cases.",
    skills: [
      "AWS (EC2, S3, RDS, Lambda, EKS)",
      "Azure (Virtual Machines, Storage, AKS)",
  ...
  },
  {
    ...
    tagline: "Container technologies and orchestration platforms",
    description:
      "Container technologies and orchestration platforms for scalable deployments",
    longDescription:
      "Modern containerization and orchestration technologies that enable efficient application packaging, deployment, and management at scale across various environments.",
    skills: [
      "Docker",
      "Kubernetes",
      "Docker Compose",
  ...
  },
  {
    ...
    tagline: "Infrastructure automation and configuration management",
    description: "Infrastructure automation and configuration management tools",
    longDescription:
      "Infrastructure as Code tools and configuration management systems that enable consistent, reproducible, and version-controlled infrastructure deployments and management.",
    skills: [
      "Terraform",
      "AWS CloudFormation",
      "Ansible",
  ...
  },
  {
    id: 4,
    title: "CI/CD & DevOps",
    tagline: "Continuous integration and deployment pipelines",
    description: "CI/CD pipelines and DevOps automation tools",
    longDescription:
      "Comprehensive CI/CD and DevOps tools that streamline development workflows, automate testing and deployment processes, and enable rapid, reliable software delivery.",
    skills: [
      "Jenkins",
      "GitLab CI/CD",
      "GitHub Actions",
  ...
  },
  {
    ...
    tagline: "System monitoring and observability platforms",
    description: "Monitoring, logging, and observability solutions",
    longDescription:
      "Advanced monitoring, logging, and observability platforms that provide comprehensive insights into system performance, health, and behavior for proactive maintenance.",
    skills: [
      "Prometheus",
      "Grafana",
  ...
  },
  {
    ...
    tagline: "Security tools and compliance frameworks",
    description: "Security tools and compliance management",
    longDescription:
      "Security tools, vulnerability scanning, and compliance frameworks that ensure infrastructure and applications meet security standards and regulatory requirements.",
    skills: [
      "HashiCorp Vault",
      "AWS IAM",
      "Azure AD",
  ...
  },
  {
    ...
    tagline: "Programming languages for automation and tooling",
    description: "Programming languages used for automation and tooling",
    longDescription:
      "Programming and scripting languages essential for automation, tooling, and infrastructure management in modern DevOps and cloud environments.",
    skills: [
      "Python",
      "Bash/Shell",
      "PowerShell",
  ...
  },
  {
    ...
    tagline: "Database systems and storage solutions",
    description: "Database and storage technologies for cloud infrastructure",
    longDescription:
      "Database systems and storage solutions that provide reliable, scalable data management for cloud-native applications and enterprise workloads.",
    skills: [
      "PostgreSQL",
      "MySQL",
      "MongoDB",
